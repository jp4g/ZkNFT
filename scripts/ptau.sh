...
yarn snarkjs powersoftau contribute zk/ptau/pot12_0000.ptau zk/ptau/pot12_0001.ptau \
    --name="First contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
yarn snarkjs powersoftau contribute zk/ptau/pot12_0001.ptau zk/ptau/pot12_0002.ptau \
    --name="Second contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
yarn snarkjs powersoftau contribute zk/ptau/pot12_0002.ptau zk/ptau/pot12_0003.ptau \
...
yarn snarkjs powersoftau beacon zk/ptau/pot12_0003.ptau zk/ptau/pot12_beacon.ptau \
...
yarn snarkjs powersoftau prepare phase2 zk/ptau/pot12_beacon.ptau zk/ptau/pot12_final.ptau -v
